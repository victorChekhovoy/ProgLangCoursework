...
// Checks if the raw symbol is a valid number
...
// Determines the type of a symbol based on its raw string value
...
// Given the type of the symbol and its raw string value, creates a new symbol of the respective type
